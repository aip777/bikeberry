...
let promosJSON = '[{"promoStatus":false,"saleSelector":"","comparePrices":false,"logoColor":"blue","logoType":"logo","addCents":false,"selector":"#price-list","fontSize":"12","position":"beforeend","pageType":"product","onChange":"","alaElement":"","dataElement":""},{"promoStatus":false,"saleSelector":"","comparePrices":false,"logoColor":"blue","logoType":"logo","addCents":false,"selector":".cart-recap__price-line-price","fontSize":"12","position":"beforeend","pageType":"cart","onChange":""}]';
		...
		if(promo.dataElement){
 			if(typeof jQuery !== 'undefined'){
				jQuery.getJSON(window.location.pathname+'.js', function(shopifyProduct) {
		          ...
		          $(promo.dataElement).change(function(){
  ...
  if(!validPrice) return;
	...
	if(callback){
      if(document.querySelector(".affirm-as-low-as")){
        if(typeof jQuery !== 'undefined'){
        	$(".affirm-as-low-as").attr('data-amount',itemPrice);
        	return callback();
        }
...
function upsertVariantALA(promo, currentProduct, callback=null){
	...
	if(selectedOption){
		...
		upsertAla(promo, currentProduct.price.toString(), thisElement, callback)
	}
}